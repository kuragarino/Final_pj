...
const LoginForm = (props) => {
    let {loginClick,passwordChange,password,userCodeChange,userCode,success,error
        ...
        const handleKeyDown = (e) => {
          if (e.key === 'Enter') {
            loginClick(); // Call the loginClick function when Enter is pressed
          }
        };
                  ...
                  <CRow className="mt-4 align-items-center">
                    ...
                    <CCol lg="8">
                      <CInputGroup>
                        ...
                        autoFocus value={userCode} onChange={userCodeChange} onKeyDown={handleKeyDown}
                        ></CInput>
                      </CInputGroup>
                    </CCol>
                  </CRow>
                  ...
                  <CRow className="align-items-center">
                    ...
                    <CInputGroup>
                        ...
                        <CInput className="login-input" placeholder='Enter Password' type='password'
                         value={password} onChange={passwordChange} onKeyDown={handleKeyDown}
                         ></CInput>
                      </CInputGroup>
                    </CCol>
                  </CRow>
